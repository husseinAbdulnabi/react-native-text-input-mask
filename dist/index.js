...
const TextInputMask = forwardRef((_a, ref) => {
    ...
    // @ts-ignore
    const _onChangeText = (masked) => __awaiter(void 0, void 0, void 0, function* () {
        setMaskedValue(masked);
        if (primaryFormat) {
    ...
    return (<TextInput {...rest} ref={input} value={maskedValue} multiline={primaryFormat && Platform.OS === "ios" ? false : multiline} onChangeText={_onChangeText}/>);
});
